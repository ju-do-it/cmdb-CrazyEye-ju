...
def get_contact_information(obj):
    ...
    #### 业务联系人 ####
    contact_group_id = obj.business_unit.contact_id  # 业务负责组id
    print("=======contact_group_id======", contact_group_id)

    contact_data = []
    contact_obj = models.UserGroup.objects.get(id=contact_group_id)
    ...
    #### 运维联系人 ####
    manager_group_id = obj.business_unit.manager_id  # 运维负责组id
    manager_data = []
    manager_obj = models.UserGroup.objects.get(id=manager_group_id)
...
########def SelectAsset(asset_id)
## 基本信息               'basic_data': get_basic_data(obj, asset_id),
## 硬件信息               'hardware_data': get_hardware_data(asset_id),
## 资产变更日志            'log_data':  get_log_data(asset_id),
...
def get_basic_data(obj, asset_id):
    ...
    basic_data = {
        ...
        'manage_ip': obj.server.private_ip,      # 管理ip
...
def get_log_data(asset_id):
    ...
    for i in obj:
        if i.creator:
            user_obj = models.UserProfile.objects.get(id=i.creator)
